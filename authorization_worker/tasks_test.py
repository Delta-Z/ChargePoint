...
class TestAuthorizationWorker(unittest.TestCase):
    ...
    @patch("authorization_worker.logger.Logger.log_authorize")
    def test_authorize_allowed(
        self, mock_logger, mock_post, mock_get, unused_mock_time_ns
    ):
    ...
    def test_authorize_timeout(
        self, mock_logger, mock_post, unused_mock_get, unused_mock_time_ns
    ):
        authorize(STATION_ID, VALID_DRIVER_TOKEN, CALLBACK_URL, FAKE_TIME + 1)
